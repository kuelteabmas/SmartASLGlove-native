...
const gloveBTID = 'B8:27:EB:14:F2:71'
...
export default class App extends Component {
  ...
  readPiZeroRSSI(peripheral) {
    BleManager.readRSSI(gloveBTID)
    .then((rssi) => {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={{marginTop: 40,margin: 20, padding:20, backgroundColor:'#ccc'}} onPress={() => this.startProcess() }>
          <Text>Read data</Text>
        </TouchableHighlight>
