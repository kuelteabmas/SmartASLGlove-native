...
var data = ""
class SignToTextScreenComp extends Component {
  ...
  constructor (props) {
    ...
    // this.messageReadState = this.messageReadState.bind(this)
  }
  componentWillMount () {
  ...
  // readFromDevice = () => {
    ...
    setInterval( () => {
      BluetoothSerial.readFromDevice().then((data) => {
        ...
        // this.setState((messageReadState) => {
        //   messageReadState = data
  ...
  render () {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.message}> { this.state.messageReadState }</Text>
...
// // var messageSentFromBt = { newMess: this.state.messageReadState } 
// class MessageTextComp extends Component {
//   render() {
//     return(
//       // <Text>Read messages from devices: ASL</Text>
//       <Text>Read messages from devices: {this.state.messageReadState} </Text>
//       // <Text>Read messages from devices: {this.messageSentFromBt} </Text>
//       // <Text>Read messages from devices: {this.readFromDevice.bind(this)} </Text>
//     )
//   }
// }
...
// export default PairingSettingsComp
export default SignToTextScreenComp

// module.exports = {
//   PairingSettingsComp: PairingSettingsComp,
//   MessageTextComp: MessageTextComp
// }